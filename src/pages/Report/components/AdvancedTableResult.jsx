...
const AdvancedTableReportResult = ({ data, loading, progress, selectedItemTypes, t, ...props }) => {

  	const columns = [
		{
			field: 'flow_out',
			title: t('destination ip'),
			defaultGroupOrder: selectedItemTypes.indexOf("ac702049-d082-4738-8efb-6593dc7c8b3d"),
		...
		},
		{
			field: 'flow_in',
			title: t('source ip'),
			defaultGroupOrder: selectedItemTypes.indexOf("e5419d6a-6ce7-4c83-9a85-331bfc3fab86"),
			grouping: false,
		...
		},
		{
			field: 'flow_port',
			title: t('port'),
			defaultGroupOrder: selectedItemTypes.indexOf("691c4399-ce06-4189-9133-c5455a0ec1c1"),
			...
			},
		{
			field: 'flow_protocol',
			title: t('protocol'),
			defaultGroupOrder: selectedItemTypes.indexOf("80cf31d6-77b8-404d-be03-2aff2fbf4334"),
...
export default withTranslation('common')(AdvancedTableReportResult);
